...
**Say you don't know.** If you're touching on a _fact_ (e.g., language-specific trivia, a hairy bit of runtime analysis), don't try to appear to know something you don't. Instead, say "_I'm not sure, but I'd guess $thing, because..._". The _because_ can involve ruling out other options by showing they have nonsensical implications, or pulling examples from other languages or other problems.
...
**Write a naive, inefficient solution and optimize it later.** Use brute force. Do whatever it takes to get _some kind_ of answer.
...
**Wait for a hint.** Don't stare at your interviewer expectantly, but do take a _brief_ second to "think"—your interviewer might have already decided to give you a hint and is just waiting to avoid interrupting.
